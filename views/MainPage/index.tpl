...
<head>
    ...
    <title>LoLi Police Department</title>
...
<body>
    <header class="header">
        <h1 class="title">Loli Police Department</h1>
    </header>
    <nav class="nav_bar">
        <a href="/login">LPD login</a>
    </nav>
    <main class="content">
        <section class="middle">
            <h2>What is the LPD</h2>
            ...
            <h2>How the LPD started</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae libero vel quisquam eos dignissimos! Enim earum perferendis, omnis vel voluptatem nemo praesentium consectetur in esse obcaecati! Accusantium reiciendis deserunt pariatur.</p>
            <h2>The revival of the LPD</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae libero vel quisquam eos dignissimos! Enim earum perferendis, omnis vel voluptatem nemo praesentium consectetur in esse obcaecati! Accusantium reiciendis deserunt pariatur.</p>
        </section>
